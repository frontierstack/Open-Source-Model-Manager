...
function buildBuilderSystemPrompt() {
    ...
    const TOOLS = new Set(['model','web_search','fetch_url','render_html','parse_json','export_file','http_request','crawl','sqlite','render_chart','create_pdf','html_to_pdf','create_file','run_python','db_store','db_query','tool']);
