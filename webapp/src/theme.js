...
const themes = {
    ...
    everforest: {
        background: { default: '#272e33', paper: '#2d353b' },
        primary: { main: '#a7c080', light: '#b8cf94', dark: '#8aa367' },
        secondary: { main: '#83c092', light: '#9ad0a6', dark: '#6aa87a' },
        success: { main: '#a7c080', light: '#b8cf94' },
        warning: { main: '#dbbc7f' },
        error: { main: '#e67e80' },
        text: { primary: '#d3c6aa', secondary: '#9da9a0' },
        divider: 'rgba(211, 198, 170, 0.12)',
        accent: '#a7c080',
    },
    tokyonight: {
        background: { default: '#1a1b26', paper: '#1f2335' },
        primary: { main: '#7aa2f7', light: '#8fb3f9', dark: '#5d86d6' },
        secondary: { main: '#bb9af7', light: '#cbb1f9', dark: '#9a78d6' },
        success: { main: '#9ece6a', light: '#b3dd88' },
        warning: { main: '#e0af68' },
        error: { main: '#f7768e' },
        text: { primary: '#c0caf5', secondary: '#a9b1d6' },
        divider: 'rgba(192, 202, 245, 0.12)',
        accent: '#7aa2f7',
    },
    cyberpunk: {
    ...
    dracula: {
        background: { default: '#282a36', paper: '#1f2029' },
        primary: { main: '#ff79c6', light: '#ff92d0', dark: '#cc5fa0' },
        secondary: { main: '#bd93f9', light: '#cdacf9', dark: '#9776c7' },
        success: { main: '#50fa7b', light: '#79fb95' },
        warning: { main: '#f1fa8c' },
        error: { main: '#ff5555' },
        text: { primary: '#f8f8f2', secondary: '#a8a89a' },
        divider: 'rgba(189, 147, 249, 0.16)',
        accent: '#ff79c6',
    },
    nord: {
        background: { default: '#2e3440', paper: '#3b4252' },
        primary: { main: '#88c0d0', light: '#a3d0de', dark: '#6d99a6' },
        secondary: { main: '#81a1c1', light: '#9bb4cd', dark: '#67809a' },
        success: { main: '#a3be8c', light: '#b8caa0' },
        warning: { main: '#ebcb8b' },
        error: { main: '#bf616a' },
        text: { primary: '#eceff4', secondary: '#aab1bc' },
        divider: 'rgba(136, 192, 208, 0.14)',
        accent: '#88c0d0',
    },
    gruvbox: {
        background: { default: '#282828', paper: '#32302f' },
        primary: { main: '#fabd2f', light: '#fad15c', dark: '#c89726' },
        secondary: { main: '#fe8019', light: '#fe9c4d', dark: '#cb6614' },
        success: { main: '#b8bb26' },
        warning: { main: '#fabd2f' },
        error: { main: '#fb4934' },
        text: { primary: '#ebdbb2', secondary: '#a89984' },
        divider: 'rgba(250, 189, 47, 0.14)',
        accent: '#fabd2f',
    },
    mocha: {
        background: { default: '#1e1e2e', paper: '#181825' },
        primary: { main: '#cba6f7', light: '#d5b8f9', dark: '#a384c5' },
        secondary: { main: '#f5c2e7', light: '#f7cdec', dark: '#c49bb9' },
        success: { main: '#a6e3a1' },
        warning: { main: '#f9e2af' },
        error: { main: '#f38ba8' },
        text: { primary: '#cdd6f4', secondary: '#9399b2' },
        divider: 'rgba(203, 166, 247, 0.14)',
        accent: '#cba6f7',
    },
    synthwave: {
        background: { default: '#241b2f', paper: '#2b2042' },
        primary: { main: '#ff71ce', light: '#ff8dd6', dark: '#cc5aa5' },
        secondary: { main: '#01cdfe', light: '#34d7fe', dark: '#00a4cb' },
        success: { main: '#05ffa1' },
        warning: { main: '#fffb96' },
        error: { main: '#ff5555' },
        text: { primary: '#f8f8f2', secondary: '#bdb5d4' },
        divider: 'rgba(255, 113, 206, 0.16)',
        accent: '#ff71ce',
    },
    'rose-pine': {
        background: { default: '#191724', paper: '#1f1d2e' },
        primary: { main: '#ebbcba', light: '#f0c9c8', dark: '#bc9694' },
        secondary: { main: '#c4a7e7', light: '#cfb6ec', dark: '#9c85b8' },
        success: { main: '#9ccfd8' },
        warning: { main: '#f6c177' },
        error: { main: '#eb6f92' },
        text: { primary: '#e0def4', secondary: '#908caa' },
        divider: 'rgba(235, 188, 186, 0.14)',
        accent: '#ebbcba',
    },
};
