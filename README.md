...
- **Webapp**: React frontend + Express backend with Docker API integration
- **llama.cpp**: CUDA-enabled for Maxwell 5.2+ GPUs
- **vLLM**: Python inference engine for Pascal 6.0+ GPUs
- **Open WebUI**: Pre-built chat interface
